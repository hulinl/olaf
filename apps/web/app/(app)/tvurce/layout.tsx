...
export const ADMIN_NAV: NavItem[] = [
  ...
  { href: "/tvurce/reference", label: "Reference" },
  { href: "/tvurce/vybaveni", label: "Vybavení" },
  { href: "/tvurce/platby", label: "Platby" },
  { href: "/tvurce/audit", label: "Aktivita" },
  { href: "/tvurce/smlouvy", label: "Smlouvy" },
  { href: "/tvurce/dokumenty", label: "Dokumenty", comingSoon: true },
];
      ...
      <div className="mx-auto w-full max-w-7xl flex-1 px-4 py-6 sm:py-10">
        <div className="flex flex-col gap-6 lg:flex-row lg:gap-8">
          ...
          {/* MAIN — `min-w-0` keeps the flex child shrinkable below
              ...
              in /tvurce/komunity/<slug>/ silently scrolls away. The
