    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <LinkButton
            href="/tvurce/akce/new/from-source"
            variant="secondary"
            size="md"
          >
            ↗ Z odkazu (Notion)
          </LinkButton>
          <LinkButton href="/tvurce/akce/new" variant="primary" size="md">
            + Vytvořit akci
          </LinkButton>
        </div>
      </div>
...
function EventCard({ event }: { event: EventSummary }) {
  const href = `/tvurce/akce/${event.workspace_slug}/${event.slug}`;
