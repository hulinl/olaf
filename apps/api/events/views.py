...
def update_event(request: Request, workspace_slug: str, event_slug: str) -> Response:
    ...
    # 2026-09-20: dřívější obousměrný sync `event.location_url` <-> Map
    # block's `map_url` byl odstraněn. User request: `location_url` je
    # odkaz na místo srazu (hero systémová dlaždice „Místo"), zatímco
    # Map block `map_url` je odkaz na trasu — mají být nezávislé.
